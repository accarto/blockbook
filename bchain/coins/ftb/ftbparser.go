...
const (
	...
	MainnetMagic wire.BitcoinNet = 0x2e627466
	// TestnetMagic is testnet network constant
	TestnetMagic wire.BitcoinNet = 0x66746674
...
func init() {
	...
	MainNetParams.PubKeyHashAddrID = []byte{36} // base58 prefix: F
	...
	// Address encoding magics
	TestNetParams.PubKeyHashAddrID = []byte{95} // base58 prefix: f
...
// FtbParser handle
type FtbParser struct {
	*btc.BitcoinLikeParser
	baseparser *bchain.BaseParser
}

// NewFtbParser returns new FtbParser instance
func NewFtbParser(params *chaincfg.Params, c *btc.Configuration) *FtbParser {
	return &FtbParser{
...
func (p *FtbParser) PackTx(tx *bchain.Tx, height uint32, blockTime int64) ([]byte, error) {
	return p.baseparser.PackTx(tx, height, blockTime)
}

// UnpackTx unpacks transaction from protobuf byte array
func (p *FtbParser) UnpackTx(buf []byte) (*bchain.Tx, uint32, error) {
